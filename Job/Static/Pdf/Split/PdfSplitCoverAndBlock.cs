...
{
    [PdfTool("Розділити", "розділити на обкладинку та блок",Description ="Розділити документ на обкладинку та блок. Перші 2 сторінки і останні - обкладинка, все інше - внутрішній блок",Icon = "split_cover_and_block",Order = 30)]
