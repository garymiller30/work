...
{
    [PdfTool("Розділити", "розділити файл на частини", Icon = "split", Description = "Розділити файл на задані частини. Ствоюється кілька файлів з вказаною кількістю сторінок", Order = 30)]
    public class PdfSplitPages : IPdfTool
    {
        ...
        public void Divider(string filePath)
        {
            using ( PDFlib p = new PDFlib())
            {
                ...
                {
                    PdfHelper.LogException(e, "PdfSplitPages");
                }
            }
        }
    }
