...
{
    [PdfTool("Візуалізація", "візуалізація твердої обкладинки", Icon = "visual_hard_cover", Order = 1,Description = "створення схеми для твердої обкладинки, перевірка схеми для твердої обкладинки")]
