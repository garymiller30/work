...
{
    [PdfTool("Візуалізація","безпечні поля", Description = "можна вказати безпечні поля з усіх сторін і передивитись/перевірити візуально документ", Icon = "visual_safe_fields",Order = 20)]
