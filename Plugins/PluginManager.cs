                ...
                foreach (var fi in files)
                {
                    ...
                    try
                    {
                        ...
                        foreach (var type in types)
                        {
                            ...
                            if (typeof(IPluginFileBrowser).IsAssignableFrom(type))
                            {
                            ...
                            if (typeof(IPluginFormAddWork).IsAssignableFrom(type))
                            {
                            ...
                            if (typeof(IPluginMail).IsAssignableFrom(type))
                            {
                            ...
                            if (typeof(IPluginPlaySound).IsAssignableFrom(type))
                            {
                            ...
                            if (typeof(IPluginJobList).IsAssignableFrom(type))
                            {
                            ...
                            if (typeof(IMqPlugin).IsAssignableFrom(type))
                            {
